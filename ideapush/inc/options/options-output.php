            ...
            <div class="inside">
                ...
                <div id="accordion">
                    ...
                    <div>
                        ...
                        <code>add_filter("idea_push_change_comment_login_link", "idea_push_change_comment_login_link_callback", 10, 2);

                        function idea_push_change_comment_login_link_callback($redirect_link, $user_id){
                            return "https://yourcustomlogin.com";
                        }</code></br>

                        <br></br><strong>Change comment login link</strong></br>
                        <em>Changes the login redirect link on the login to comment link which is shown to logged out users before they can make a comment</em></br>
                        ...
                        <br></br><strong>Change edit link</strong></br>
                        <em>Changes the edit link on the idea form shown on the board page - the default behaviour is to toggle a quick profile edit section</em></br>
                        <code>add_filter( "idea_push_change_edit_link", "idea_push_change_edit_link_callback", 10, 2 );
                        function idea_push_change_edit_link_callback( $link, $user_id ) {
                        
                            //do something awesome with $link
                            return "https://mycustomeditlink.com";
                        ...
                        <br></br><strong>Prevent flushing of rewrite rules on idea creation</strong></br>
                        <em>Prevent flushing of rewrite rules on idea creation. The below code would prevent the flushing of rewrite rules.</em></br>
                        <code>add_filter("idea_push_flush_rewrite_rules_on_idea_creation","idea_push_flush_rewrite_rules_on_idea_creation_callback",10,1);

                        function idea_push_flush_rewrite_rules_on_idea_creation_callback($value){
                            return false;
                        }</code></br>
